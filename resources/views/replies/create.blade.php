<x-app-layout>
    <x-slot name="meta">
        ...
        <title>リプライ投稿 | {{ config('app.name', 'Q & A site - ナゼナゼの実 -') }}</title>
                ...
                <div class="bg-white py-6 sm:py-8 lg:py-12">
                    ...
                    <div class="bg-white sm:py-8 lg:py-12">
                        <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
                            ...
                            @endif
                            <!-- form - start -->
                            <form class="max-w-screen-md grid sm:grid-cols-2 gap-4 mx-auto" action="{{ route('replies.store') }}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}

                                <div class="sm:col-span-2">
                                    <label for="comment" class="inline-block text-gray-800 text-sm sm:text-base mb-2"><b>リプライ内容</b></label>
                                    <textarea name="reply" class="w-full h-250 bg-gray-50 text-gray-800 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3"></textarea>
                                </div>
